    ...
    async resolveLifecycleContext(work) {
      const { data: row, error } = await supabase.from("class_bookings")
        .select([
          ...
          "provider_client_service_id", "provider_sale_id", "provider_cart_id",
          "provider_transaction_id", "provider_payment_id",
          "cancellation_status", "restoration_status",
      ...
      return {
        ...
        booking: {
          ...
          saleId: row.provider_sale_id,
          cartId: row.provider_cart_id,
